...
const ComUsecontentBack20160618 = () => {
  ...
  return (
    <S.Container>
      ...
      <S.Licontainer>
        <S.LiList> 본 이용약관은 (주)네띠앙닷컴(이하 &quot;회사&quot;라 합니다)에서 운영하는 사이트인 네띠앙(www.netian.com), 아레오(www.arreo.com)의 서비스를 이용함에 있어 회원과 회사간의 권리, 의무 및 책임사항 규정을 목적으로 합니다.</S.LiList>
      </S.Licontainer>
      ...
      <S.Licontainer>
        ...
        <S.NumberList><span>2.</span>회사는 아래 호에 해당하는 이용 신청에 대하여는 이를 승낙하지 아니할 수 있습니다.
          <S.Licontainer>
            ...
            <S.NumberList><span>⑤</span>서비스 사용 중 약관에 정한 사항들을 위반하여 강제탈퇴 된 회원이 또다시 신청한 경우</S.NumberList>
          </S.Licontainer>
        </S.NumberList>
      </S.Licontainer>
      ...
      <S.Licontainer>
        <S.NumberList><span>1.</span>회원은 서비스 이용 시 다음 각 호의 행위를 하지 않아야 합니다.
          <S.Licontainer>
            ...
            <S.NumberList><span>⑩</span>공공질서 및 미풍양속에 위반되는 내용의 정보, 문장, 도형 등을 타인에게 유포하는 행위</S.NumberList>
            ...
            <S.NumberList><span>⑭ </span>기타 관계법령에 위배되는 행위</S.NumberList>
          </S.Licontainer>
        </S.NumberList>
        ...
        <S.NumberList><span>5.</span>회원은 문자메시지 발송 전 반드시 발신번호 사전등록을 해야 하며, 발신번호 사전 등록 시 발신번호 세칙을 반드시 준수해야 합니다. </S.NumberList>
        <S.NumberList><span>6.</span>회원은 거짓으로 발신번호를 표시해서 문자메시지를 발송해서는 아니되며, 그로인해 발생한 문제에 대해서는 회원에게 책임이 있습니다.</S.NumberList>
      </S.Licontainer>
      ...
      <S.Licontainer>
        ...
        <S.NumberList><span>7.</span>회사는 회원이 다음 사항에 해당하는 행위를 하였을 경우, 사전 통지 없이 이용 계약을 해지하거나 또는 기간을 정하여 서비스 이용을 중지할 수 있습니다. 또한, 해당 불법행위에 대한 자료를 요청한 국가기관 등에 제출할 수 있습니다
          <S.Licontainer>
      ...
      <S.BottomText>
        ...
        <S.Licontainer>
          ...
          <S.LiList>변경공고일자 : 2015년 12월 31일</S.LiList>
          <S.LiList>시행일자 : 2015년 12월 31일</S.LiList>
        </S.Licontainer>
      </S.BottomText>
...
export default ComUsecontentBack20160618;