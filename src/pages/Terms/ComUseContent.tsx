    ...
    <S.Container>
      ...
      <S.MidText>
        <S.Licontainer>
          ...
          <S.LiList>본 이용약관은 (주)서울이동통신(이하 &quot;회사&quot;라 합니다)에서 운영하는 사이트인 아레오(www.arreo.com)의 서비스를 이용함에 있어 회원과 회사간의 권리, 의무 및 책임사항 규정을 목적으로 합니다.</S.LiList>
        </S.Licontainer>
        ...
        <S.Licontainer>
          ...
          <S.SubTitle>이 약관에서 사용하는 용어의 정의는 다음의 호와 같습니다.</S.SubTitle>
          ...
          <S.NumberList><span>8.</span>충전 : 캐쉬 및 포인트를 일정량 확보하고자 특정 지불수단을 이용하여 현금을 회사에 지불하거나 회사가 지정한 여타의 방법으로 구매 혹은 획득하는 행위로 현금 1원당 1캐쉬가 충전됨</S.NumberList>
        </S.Licontainer>
        ...
        <S.Licontainer>
          ...
          <S.NumberList><span>2.</span>회사는 아래 호에 해당하는 이용 신청에 대하여는 이를 승낙하지 아니할 수 있습니다.
            <S.Licontainer>
              <S.NumberList><span>(1)</span> 설비에 여유가 없는 경우</S.NumberList>
              <S.NumberList><span>(2)</span> 기술상 지장이 있는 경우</S.NumberList>
              <S.NumberList><span>(3)</span> 기타 회사의 사정상 이용 승인이 곤란한 경우</S.NumberList>
              <S.NumberList><span>(4)</span> 사회의 안녕질서 또는 미풍양속의 현저한 저해, 법률 위반을 목적으로 신청한 것으로 판단될 경우</S.NumberList>
              <S.NumberList><span>(5)</span> 서비스 사용 중 약관에 정한 사항들을 위반하여 강제탈퇴 된 회원이 또다시 신청한 경우</S.NumberList>
            </S.Licontainer>
          </S.NumberList>
        </S.Licontainer>
        ...
        <S.Licontainer>
          ...
          <S.NumberList><span>4.</span>발신번호 변작으로 확인된 가입자에 대하여 회사는 재가입을 금지할 수 있습니다.</S.NumberList>
        </S.Licontainer>
        ...
        <S.Licontainer>
          ...
          <S.NumberList><span>1.</span>회원은 서비스 이용 시 다음 각 호의 행위를 하지 않아야 합니다.
            <S.Licontainer className='padding'>
              <S.NumberList><span>(1)</span> 회원가입 신청 또는 회원정보 변경 시 허위 내용을 등록하는 행위</S.NumberList>
              <S.NumberList><span>(2)</span> 회사의 승인을 받지 않고 다른 사용자의 개인정보를 수집 또는 저장하는 행위</S.NumberList>
              <S.NumberList><span>(3)</span> 서비스에서 얻은 정보를 회사의 사전 승낙 없이 복제하거나 이를 변경, 출판 및 방송, 인터넷 등 기타 매체에 사용하거나 타인에게 제공하는 행위</S.NumberList>
              <S.NumberList><span>(4)</span> 이용자 아이디(ID)를 타인과 거래하는 행위</S.NumberList>
              <S.NumberList><span>(5)</span> 회사의 운영진, 직원 또는 관계자를 사칭하는 행위</S.NumberList>
              <S.NumberList><span>(6)</span> 회사로부터 특별한 권리를 부여 받지 않고 회사의 클라이언트 프로그램을 변경하거나, 회사의 서버를 해킹하거나, 웹사이트 또는 게시된 정보의 일부분 또는 전체를 임의로 변경하는 행위</S.NumberList>
              <S.NumberList><span>(7)</span> 회사 프로그램상의 버그를 악용하는 행위</S.NumberList>
              <S.NumberList><span>(8)</span> 서비스에 위해를 가하거나 고의로 방해하는 행위</S.NumberList>
              <S.NumberList><span>(9)</span> 본 서비스를 통해 얻은 정보를 회사의 사전 승낙 없이 서비스 이용 외의 목적으로 복제하거나, 이를 출판 및 방송 등에 사용하거나, 제3자에게 제공하는 행위</S.NumberList>
              <S.NumberList><span>(10)</span> 공공질서 및 미풍양속에 위반되는 내용의 정보, 문장, 도형 등을 타인에게 유포하는 행위</S.NumberList>
              <S.NumberList><span>(11)</span> 다른 이용자를 희롱 또는 위협하거나, 고통 또는 불편을 주는 행위</S.NumberList>
              <S.NumberList><span>(12)</span> 범죄와 결부된다고 객관적으로 판단되는 행위</S.NumberList>
              <S.NumberList><span>(13)</span> 본 약관을 포함하여 기타 회사가 정한 제반 규정 또는 이용 조건을 위반하는 행위</S.NumberList>
              <S.NumberList><span>(14)</span> 제3자를 위해 본 서비스를 이용하는 행위(네띠앙비서서비스에 한함)</S.NumberList>
              <S.NumberList><span>(15)</span> 서비스 이용에 따른 거래금액 및 또는 이용수수료를 정해진 기일로부터 상당한 기간내에 지급하지 않는 행위</S.NumberList>
              <S.NumberList><span>(16)</span> 회사와의 커뮤니케이션에 있어 선정적이거나 폭력적인 언어를 반복적으로 사용하는 행위</S.NumberList>
              <S.NumberList><span>(17)</span> 기타 관계법령에 위배되는 행위</S.NumberList>
            </S.Licontainer>
          </S.NumberList>
          <S.NumberList><span>2.</span>회원은 관계법령, 이 약관에서 규정하는 사항, 서비스 이용 안내 및 서비스와 관련하여 공지사항에 게시하거나 별도로 공지한 준수 사항을 반드시 준수하여야 합니다.</S.NumberList>
          <S.NumberList><span>3.</span>이용자는 그 귀책사유로 인하여 회사나 다른 이용자가 입은 손해를 배상할 책임이 있습니다.</S.NumberList>
          <S.NumberList><span>4.</span>회원이 본 조 각 항에서 정한 회원의 의무를 위반하는 경우, 회사는 즉시 회원의 회원자격을 박탈할 수 있습니다.</S.NumberList>
          <S.NumberList><span>5.</span>회사는 회원이 본인 명의가 아닌 타인의 전화번호를 부정하게 사용하는 경우에 서비스의 전부 또는 일부의 이용을 제한할 수 있습니다.</S.NumberList>
          <S.NumberList><span>6.</span>본 조 제 5항의 경우, 회사는 차단 된 문자 서비스에 관한 자료(변작된 발신번호, 차단시각, 전송자명 등)를 1년간 보관.관리하고 이를 한국인터넷진흥원 등 관계기관에 제출할 수 있습니다.</S.NumberList>
          <S.NumberList><span>7.</span>회원은 회원가입 시 부정가입 방지를 위해 회사가 제공하는 본인인증방법으로 본인인증을 거친 후 서비스를 이용하여야 합니다.</S.NumberList>
          <S.NumberList><span>8.</span>회원은 전기통신사업법 제 84 조의 2(전화번호의 거짓표시 금지 및 이용자 보호)에 따라 발신번호 사전등록 후 등록된 번호로만 문자 메시지를 발송 하여야 합니다.</S.NumberList>
          <S.NumberList><span>9.</span>회원은 정당하지 않은 방법으로 전화번호를 변경하여 발신하는 경우, 번호변작 발견 시 관련 법규에 따라 과태료가 부과될 수 있습니다.</S.NumberList>
        </S.Licontainer>
        ...
        <S.Licontainer>
          ...
          <S.NumberList><span>1.</span>회사가 제공하는 통신서비스 중 015번호를 이용한 서비스는 회사에서 제공하는 “무선호출이용약관”에 동의한 후 이용할 수 있습니다.</S.NumberList>
        ...
        <S.Licontainer>
          ...
          <S.NumberList><span>1.</span>회사는 회원이 게시하거나 등록하는 서비스의 내용물이 아래 호에 해당한다고 판단되는 경우에 사전통지 없이 삭제할 수 있습니다.
            <S.Licontainer>
              <S.NumberList><span>(1)</span> 다른 회원 또는 제3자를 비방하거나 중상모략으로 명예를 손상시키는 내용인 경우</S.NumberList>
              <S.NumberList><span>(2)</span> 공공질서 및 미풍양속에 위반되는 내용인 경우</S.NumberList>
              <S.NumberList><span>(3)</span> 민, 형사상에 저촉되는 범죄적 행위에 결부된다고 인정되는 내용일 경우</S.NumberList>
              <S.NumberList><span>(4)</span> 회사의 저작권, 제 3 자의 저작권 등 기타 권리를 침해하는 내용인 경우</S.NumberList>
              <S.NumberList><span>(5)</span> 회사에서 규정한 게시기간을 초과한 경우</S.NumberList>
              <S.NumberList><span>(6)</span> 회원이 자신의 홈페이지와 게시판에 음란물을 게재하거나 음란사이트 등을 링크하는 경우</S.NumberList>
              <S.NumberList><span>(7)</span> 의도적으로 동일한 내용 및 주장을 지속적으로 공시하는 경우</S.NumberList>
              <S.NumberList><span>(8)</span> 게시판의 주제와 일치하지 않는 내용을 게제 하는 경우</S.NumberList>
              <S.NumberList><span>(9)</span> 기타 관계법령에 위반된다고 판단되는 경우</S.NumberList>
            </S.Licontainer>
          </S.NumberList>
        ...
        <S.Licontainer>
          ...
          <S.NumberList><span>1.</span>회사는 다음 각 호에 해당하는 경우 서비스의 전부 또는 일부를 제한하거나 정지할 수 있습니다.
            <S.Licontainer className='padding'>
              <S.NumberList><span>(1)</span> 서비스 설비의 보수 등 공사로 인한 부득이한 경우</S.NumberList>
              <S.NumberList><span>(2)</span> 회원이 회사의 영업활동을 방해하는 경우</S.NumberList>
              <S.NumberList><span>(3)</span> 정전, 제반 설비의 장애 또는 이용량의 폭주 등으로 정상적인 서비스 이용에 지장이 있는 경우</S.NumberList>
              <S.NumberList><span>(4)</span> 서비스 제공업자와의 계약 종료 등과 같은 회사의 제반 사정으로 서비스를 유지할 수 없는 경우</S.NumberList>
              <S.NumberList><span>(5)</span> 미래창조과학부 또는 한국인터넷진흥원(KISA)등의 기관에서 번호 변작 등으로 판명되어 이용정지를 요청한 경우 회사는 회원의 회선 또는 서비스를 중지할 수 있습니다. 단, 객관적인 증빙자료 등으로 악의적인 목적없이 회원의 실수로 인해 변작된 경우 회원의 소명을 받고 회사 심사 후 서비스를 재개할 수 있습니다.</S.NumberList>
              <S.NumberList><span>(6)</span> 회원은 거짓으로 문자메세지의 발신번호를 표시해서 발송하는 등의 전기통신사업법이나정보통신망법 등의 관련 법을 위반해서는 아니되며, 법률을 위반하여 문자메시지를 발송한 경우 그에 따른 모든 민,형사상 책임을 부담합니다.</S.NumberList>
              <S.NumberList><span>(7)</span> 방송통신위원회ㆍ한국인터넷진흥원ㆍ미래창조과학부 등 관계기관이 불법스팸메세지ㆍ문자피싱메세지 등 불법행위의 전송사실을 확인하여 이용정지를 요청하는 경우</S.NumberList>
              <S.NumberList><span>(8)</span> 이용자가 전송하는 광고로 인하여 회사의 서비스 제공에 장애를 야기하거나 야기할 우려가 있는 경우</S.NumberList>
              <S.NumberList><span>(9)</span> 이용자가 전송하는 광고의 수신자가 스팸메세지로 신고하는 경우</S.NumberList>
              <S.NumberList><span>(10)</span> 이용자에게 제공하는 서비스가 스팸메시지 전송에 이용되고 있는 경우</S.NumberList>
              <S.NumberList><span>(11)</span> 이용자가 제10조[회원의 의무] 제5항을 위반하여 발신번호를 변작하는 등 거짓으로 표시한 경우</S.NumberList>
            </S.Licontainer>
          </S.NumberList>
        ...
        <S.Licontainer>
          ...
          <S.NumberList><span>2.</span>요금 지불을 위한 캐쉬 및 결제에 관련된 모든 사항은  &quot;아레오 이용요금정책&quot;의 개별방침에 따릅니다. 일부 제휴 서비스의 경우 별도의 이용수수료가 부과될 수 있습니다.</S.NumberList>
        ...
        <S.Licontainer>
          ...
          <S.NumberList><span>1.</span>캐쉬는 약관에 따라 환불할 수 있으며 서비스 계약을 해지할 수 있습니다. 단, 각 호에 해당하는 경우에는 환불되지 않습니다.
            <S.Licontainer>
              <S.NumberList><span>(1)</span> 회원의 귀책사유로 탈퇴가 된 경우</S.NumberList>
              <S.NumberList><span>(2)</span> 제 10조 회원의 의무에 따라 회원 자격을 상실한 경우</S.NumberList>
            </S.Licontainer>
          </S.NumberList>
          <S.NumberList><span>2.</span>회사는 환불신청이유를 심사한 후, 제정경제부에서 고시한 &lt;인터넷이용관련소비자피해보상&gt; 상 규정에 한 위약금(결제수수료 및 송금비용에 따라 10,000원 이상 시 환불금액 10%, 이하 시 1,000원)을 공제한 후 회원의 요청금액을 환불합니다.</S.NumberList>
        ...
        <S.Licontainer>
          ...
          <S.NumberList><span>3.</span>탈퇴 시 각 호에 따라 해당포인트를 차감합니다.
            <S.Licontainer>
              <S.NumberList><span>(1)</span> 남아있는 캐쉬의 전액을 환불 요청 할 경우 : 아레오에서 지급된 포인트 전액을 회수</S.NumberList>
              <S.NumberList><span>(2)</span> 입금 후 해당 금액 일부를 사용하고, 일부를 환불요청 할 경우 : 아레오에서 지급된 포인트 전액을 회수</S.NumberList>
              <S.NumberList><span>(3)</span> 입금 후 해당 금액을 그대로 환불요청 할 경우 : 해당 충전으로 인해 생긴 포인트만 회수</S.NumberList>
            </S.Licontainer>
          </S.NumberList>
        ...
        <S.Licontainer className='padding'>
          ...
          <S.NumberList><span>5.</span>회사는 이용자가 스팸메세지ㆍ문자피싱메세지 전송 등 불법행위를 한 사실을 확인한 경우 한국인터넷진흥원 불법스팸대응센터 등 관계기관에 관련 자료를 첨부하여 신고할 수 있으며, 스팸메세지ㆍ문자피싱메세지 등으로 인지되는 문자메시지에 대해서 차단을 할 수 있습니다.</S.NumberList>
        ...
        <S.Licontainer>
          ...
          <S.NumberList><span>7.</span>회사가 직접적인 재화의 공급자가 아닌 단순 매개, 안내 업무만을 수행하는 경우 다음과 같이 책임이 제한됩니다.
            <S.Licontainer>
              <S.NumberList><span>1)</span> 실제 공급자가 제공하는 재화 또는 서비스의 적법성 및 권리의 완전성까지 보장하지 않습니다.</S.NumberList>
              <S.NumberList><span>2)</span> 이용자의 위탁, 위임, 요청에 따라 제공하는 정보 기타 안내의 내용은 부정확할 수 있으며, 정보 기타 안내의 내용을 이용할 지 여부는 최종적으로 이용자의 결정에 따릅니다.</S.NumberList>
              <S.NumberList><span>3)</span> 회사는 본조에 따라 이용자에게 발생된 사고, 손해 등의 발생시 회사의 귀책사유가 있는 경우를 제외하고 면책됩니다.</S.NumberList>
            </S.Licontainer>
          </S.NumberList>
        </S.Licontainer>

        <S.Licontainer>
          <S.Title>제26조 (관할법원)</S.Title>
      ...
      <S.BottomText>
        <S.Licontainer>
          <S.Title>(부칙)</S.Title>
          <S.LiList>
            [시행일] 본 이용약관은 2009년 10월 14일부터 적용되며, 2008년 7월 25일부터 적용되던 종전약관은 본약관으로 대체됩니다. 개정된 이용약관의 적용일자 이전 가입자 또한 개정된 이용약관의 적용을 받습니다.<br />
            변경공고일자 : 2016년 9월 01일<br />
            시행일자 : 2017년 12월 06일<br />
          </S.LiList>
          <S.LiList>
            <Link to='/ComUsecontentBack20171201' style={{ float: 'right' }}>
              <BaseButton
                width='120px'
                height='30px'
