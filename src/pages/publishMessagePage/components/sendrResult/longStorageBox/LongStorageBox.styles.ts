...
export const LongStorageBox = styled.div`
    margin-bottom:50px;
`


/* 왼쪽 구역 */
export const LongStorageBoxLeftZone = styled.div` 
...
`
/* 전송결과 상세내용 구역 Wrap */
export const LongStorageBoxLeftDataView = styled.div`
    display:flex;
...
/* 전송결과 테이블 Wrap */
export const LongStorageBoxTable = styled.div`
    form {
