...
import { formatDateDate } from 'apis/utils/formats/dateFormatUtil';
...
const POBox015Mock = ({
  ...
  console.log('subState : ', subState, 'initial015SubPage : ', initial015SubPage?.second);
  return (
    <S.POBox015Wrap>
          ...
          {subState === null ? (
            <div className="UnregisteredWrap">
              <div className="signUpButton">
                <button onClick={() => say015SubHandle(setOpen015SubPage, initial015SubPage.second)}>
                  Say 015 서비스 가입하기
                </button>
              </div>
            ...
            <div className="UnregisteredWrap">
              <div className="signUpButton">
                <button onClick={() => say015SubHandle(setOpen015SubPage, subState)}>Say 015 서비스 구독하기</button>
              </div>
              <div className="helpText">
                <p>
                  * 현재 {storageUser}님은 {formatDateDate(authorityData?.subsEndDate)} 이후로 구독이 만료된 회원입니다.
                  <br />
                  Say 015 서비스 구독 후 서비스를 재이용하실 수 있습니다.
                </p>
              </div>
            </div>
          )}
